...
const { SERVICE_SCHEDULES, occurrences } = require('../apps/api/src/modules/recurring-services/service-schedules.ts');
...
async function main() {
  ...
  // 4. Upsert all 9 Service Schedules with recurrence rules
