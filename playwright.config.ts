...
export default defineConfig({
  ...
  projects: [
    { name: 'chromium', testMatch: ['web.spec.ts', 'admin.spec.ts', 'pwa.spec.ts', 'device.spec.ts', 'auth.spec.ts'], use: { ...devices['Desktop Chrome'] } },
    { name: 'mobile-web', testMatch: ['web.spec.ts', 'admin.spec.ts', 'pwa.spec.ts', 'device.spec.ts'], use: { ...devices['iPhone 13'], defaultBrowserType: 'chromium' } },
    { name: 'webkit', testMatch: ['web.spec.ts', 'admin.spec.ts', 'pwa.spec.ts', 'device.spec.ts'], use: { ...devices['Desktop Safari'] } },
    { name: 'mobile-safari', testMatch: ['web.spec.ts', 'admin.spec.ts', 'pwa.spec.ts', 'device.spec.ts'], use: { ...devices['iPhone 13'] } },
    { name: 'firefox', testMatch: ['web.spec.ts', 'admin.spec.ts', 'pwa.spec.ts', 'device.spec.ts'], use: { ...devices['Desktop Firefox'] } },
