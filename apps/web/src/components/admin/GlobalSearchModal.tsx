...
const STATIC_NAV_RESULTS: SearchResultItem[] = [
  ...
  { id: 'nav-events', title: 'Events & Services Hub', subtitle: 'List of all church services, syncs, and events', category: 'navigation', href: '/admin/events' },
  { id: 'nav-ops-board', title: 'Agendas & Operations Board', subtitle: 'Order of business and operational sessions', category: 'navigation', href: '/admin/events?view=operations' },
