...
const NAVIGATION_TREE: NavParent[] = [
  ...
  },
  {
    ...
    label: 'Approvals',
    icon: CheckSquare,
    anyOf: ['approvals.read', 'approvals.act', 'excuses.review', 'welfare.read'],
    children: [
      ...
      { href: '/admin/welfare', label: 'Welfare Requests', icon: HeartHandshake, anyOf: ['welfare.read', 'welfare.create', 'approvals.read'] },
  ...
  },
  {
    ...
    label: 'Finance',
    icon: DollarSign,
    anyOf: ['dues.read', 'payments.read', 'expenses.read', 'welfare.read'],
    children: [
      { href: '/admin/finance', label: 'Overview', icon: DollarSign, anyOf: ['dues.read', 'payments.read'] },
      { href: '/admin/welfare', label: 'Welfare Fund', icon: HeartHandshake, anyOf: ['welfare.read', 'welfare.create'] },
